...
public class TreeMapHandson {
	...
	public TreeMap<String, Integer> createMatchesMap(String cricketDataset){
		TreeMap<String, Integer> nameWithNumberofMatchesMap = new TreeMap<String, Integer>();
		TreeMap<String, Integer> nameWithAverageScore = new TreeMap<String, Integer>();
		TreeMap<String, Integer> nameWithTotalScore = new TreeMap<String, Integer>();
		...
		for(HashMap.Entry<String, Integer> positionEntry: nameWithTotalScore.entrySet()) {
	...
	public String getQuery(String cricketDataset, String query) {
		...
		if(queryType.length == 3) {
			...
			TreeMap<Integer, String> resulMap = new TreeMap<Integer, String>();
			...
			for(Map.Entry<String, Integer> entry:playerScoreMap.entrySet()) {
				if(entry.getValue()>thresholdScore) {
					...
					resulMap.put(position, entry.getKey());
				}	
			}
			for(Map.Entry<Integer, String> resultEntry : resulMap.entrySet()) {
